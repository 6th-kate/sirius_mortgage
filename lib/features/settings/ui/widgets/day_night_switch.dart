...
/// This is the code of day\_night\_switch dart package,
/// which, somehow, I was not able to configure the size of.
/// Thus, the same file, another magical numbers.
///
/// Comes under MIT license.
class DayNightSwitch extends StatefulWidget {
  const DayNightSwitch({
    ...
    this.sunImage,
    this.moonImage,
    this.sunColor = const Color(0xFFFBEA81),
...
class _DayNightSwitchPainter extends ToggleablePainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Offset trackPaintOffset =
     ...
     double thumbRadius = _kThumbRadius;
